...
(function(){
	...
	jQuery('#scrollToContent').click(function(e){
		e.preventDefault();
		jQuery.scrollTo("#CompletedProjects", 500, { offset:-(jQuery('#header .top').height()), axis:'y' });
	});

	jQuery('#scrollToContact').click(function (e) {
	    e.preventDefault();
	    jQuery.scrollTo("#contact", 500, { offset: -(jQuery('#header .top').height()), axis: 'y' });
	});

	jQuery('#scrollToHome').click(function (e) {
	    e.preventDefault();
	    jQuery.scrollTo("#header", 500, { offset: -(jQuery('#header .top').height()), axis: 'y' });
	});

	jQuery('#scrollToHome2').click(function (e) {
	    e.preventDefault();
	    jQuery.scrollTo("#header", 500, { offset: -(jQuery('#header .top').height()), axis: 'y' });
	});
